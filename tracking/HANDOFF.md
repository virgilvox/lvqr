...
README "Runtime mutation surface" sections and this HANDOFF are current as of `ffeb362`. The operator console is feature-complete against the kickoff prompt's definition of done.
